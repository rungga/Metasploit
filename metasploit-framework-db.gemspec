...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<metasploit-credential>, ["~> 0.13.17"])
      s.add_runtime_dependency(%q<metasploit_data_models>, ["~> 0.22.6"])
      ...
      s.add_dependency(%q<metasploit-credential>, ["~> 0.13.17"])
      s.add_dependency(%q<metasploit_data_models>, ["~> 0.22.6"])
